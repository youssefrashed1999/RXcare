...
object ChatMapper {
    ...
    fun mapMessageToDomain(messageResponse: MessageResponse): Message {
        return Message(
            ...
            messageType = if (!messageResponse.imageUrl.isNullOrBlank()) MessageType.IMAGE else MessageType.TEXT,
    ...
    fun mapMessagesToDomain(messageResponses: List<ChatHistoryResponse>, chatId: String): List<Message> {
        return messageResponses.map { dto ->
            Message(
                ...
                messageType = if (!dto.imageUrl.isNullOrBlank()) MessageType.IMAGE else MessageType.TEXT,
